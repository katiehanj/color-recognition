...
port = 1883
channel_id = '1610003'
write_api_key = 'DU8ZKJRFG68FZEMB'
...
while True:
        ...
        for a in borderc11:
                ...
                if Carea > 1500:
                    ...
                    cy = int(centroid["m01"]/ centroid["m00"])
                    cv2.circle(frame,(cx,cy),1,(0,0,0),0)
                    cv2.putText(frame, "Gray", (cx-10, cy-10), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255))
                    count_grey += 1   
        if cv2.waitKey(1) & 0xFF == ord('q'):
                break
        cv2.imshow("result",frame)
        data = "field1="+str(count_red)+"&field2="+str(count_green)+"&field3="+str(count_blue)+"&field4="+str(count_yellow)+"&field5="+str(count_pink)+"&field6="+str(count_grey)
